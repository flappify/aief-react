    ...
    render()
    {
        return(
            <div className="footer">
                ...
                <div className="cr">
                    <h1>Copyright &copy; 2019 AIEF - ALL INDIA EKTA FOUNDATION. All rights reserved. |  This website is made & maintained with <a href="https://www.flappify.com" target="_blank" rel="noopener noreferrer"><i className="fas fa-heart"></i></a> by Flappify</h1>
                </div>
            </div>
        )
    }
